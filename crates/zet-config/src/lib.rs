...
pub use config::{
    ...
    Loaded, MAX_CURSOR_THICKNESS, MAX_FONT_SIZE, MIN_CURSOR_THICKNESS, MIN_FONT_SIZE, Severity,
    TabPosition, TabSettings, WindowSettings, default_keymap, default_path, load, load_default,
    palette_for, repaired, save,
};
